...
url: /linux/2011/12/25/install-centos-via-network-without-cd-rom-and-without-usb/
categories:
- linux
aliases:
- /linux/2011/12/26/install-centos-via-network-without-cd-rom-and-without-usb/
---
